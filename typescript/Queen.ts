...
let evah = new Queen("Evah Destruction", 7, 7, 8, 9, 9, 6, 6, "EvahD");
...
let lmd_2 = [abhora, astrud, biqtch, dahli, dollyablack, evah, hoso, jamesm, landoncider, priscillachambers, saint, sigourney, victoriaelizabeth];
